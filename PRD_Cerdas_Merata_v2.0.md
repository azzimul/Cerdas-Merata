...
| Attribute | Detail |
|-----------|--------|
| Document Version | v2.0 — Full Redesign: Auth, Announcement System, English UI |
| Date | June 2026 |
...
| Category | Rules | Max |
|----------|-------|-----|
| A — Poverty (Income) | A1–A5 (income tiers) | 10 pts |
| B — Dependents | B1–B3 (dependent count) | 6 pts |
| C — Infrastructure | C1–C4 (bill tiers) + C5–C7 (wattage tiers) | 11 pts |
| D — Social | D1–D2 (parent status) + D3–D5 (occupation) | 10 pts |
| E — Academic | E1–E4 (GPA tiers) − E5 (other scholarship deduction) | 5 pts (+/−8) |
...
| Applicant Table | Rank, ID, Name, Score, Status badge, Anomaly flag, Date Applied, Actions |
| Filters | By status, anomaly, name search |
| Trace Modal | Full reasoning breakdown per category (always visible to admin) |
| Disqualify | Mark applicant as disqualified with mandatory reason; triggers cascade |
| Override | Force-change any applicant's status (qualified/waiting_list/rejected) with reason |
...
| Human Oversight | Admin can override any AI decision with an auditable reason |
...
- Human oversight: override + disqualify ✓
- Anomaly detection: 3 rules ✓
